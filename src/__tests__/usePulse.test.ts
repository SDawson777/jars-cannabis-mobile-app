...
describe('usePulse Hook', () => {
  ...
  describe('default _values', () => {
    it('should use default _values when no options provided', () => {
      const { result } = renderHook(() => usePulse());
    ...
    it('should use default _values for partial options', () => {
...
describe('usePulseCTA Hook', () => {
  ...
  describe('configuration', () => {
    ...
    it('should respect haptics setting', () => {
      const { result } = renderHook(() => usePulseCTA(mockOnPress, { enableHaptics: false }));
