...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@react-navigation/native-stack$':
      '<rootDir>/tests/__mocks__/@react-navigation/native-stack.js',
    '^expo-av$': '<rootDir>/tests/__mocks__/expo-av.js',
    '^react-native-shimmer-placeholder$':
      '<rootDir>/tests/__mocks__/react-native-shimmer-placeholder.js',
    ...
    '^react-native/jest/mockNativeComponent\\.js$':
      '<rootDir>/tests/__mocks__/mockNativeComponent.js',
    '^react-native/jest/mockNativeComponent': '<rootDir>/tests/__mocks__/mockNativeComponent.js',
    '^react-native/Libraries/Utilities/codegenNativeComponent$':
      '<rootDir>/tests/__mocks__/codegenNativeComponent.js',
    '^react-native/Libraries/Utilities/codegenNativeComponent':
      '<rootDir>/tests/__mocks__/codegenNativeComponent.js',
