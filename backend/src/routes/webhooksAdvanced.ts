      ...
      res.json({
        deliveries: [
          ...
          },
          {
            ...
            payload: { orderId: 'order-122', total: 89.5 },
            responseStatus: 200,
            responseBody: '{"received": true}',
            latencyMs: 98,
            success: true,
      ...
      res.json({
        eventTypes: [
          ...
          { eventType: 'product.recall', description: 'Fired when a product is recalled' },
          {
            ...
            description: 'Fired when a product is back in stock',
          },
          ...
          {
            eventType: 'personalization.rule_toggled',
            description: 'Fired when a personalization rule is toggled',
          },
          ...
          { eventType: 'inventory.low_stock', description: 'Fired when inventory is low' },
          {
            ...
            description: 'Fired when delivery status changes',
          },
        ],
      });
    } catch (error) {
