 ...
 */
notificationsRouter.put('/notifications/preferences', requireAuth, async (req: Request, res: Response) => {
 ...
 */
notificationsRouter.post('/notifications/channels/:channelId/toggle', requireAuth, async (req: Request, res: Response) => {
 ...
 */
notificationsRouter.get('/notifications/quiet-hours', requireAuth, async (req: Request, res: Response) => {
  try {
    res.json({
      enabled: true,
      startTime: '22:00',
 ...
 */
notificationsRouter.put('/notifications/quiet-hours', requireAuth, async (req: Request, res: Response) => {
 ...
 */
notificationsRouter.get('/notifications/topics', requireAuth, async (req: Request, res: Response) => {
  try {
    res.json({
      topics: [
        {
 ...
 */
notificationsRouter.post('/notifications/topics/:topicId/subscribe', requireAuth, async (req: Request, res: Response) => {
 ...
 */
notificationsRouter.post('/notifications/topics/:topicId/unsubscribe', requireAuth, async (req: Request, res: Response) => {
  const { topicId } = req.params;
 ...
 */
notificationsRouter.post('/notifications/register-device', requireAuth, async (req: Request, res: Response) => {
  const uid = (req as any).user.userId as string;
 ...
 */
notificationsRouter.get('/notifications/campaigns', requireAuth, async (req: Request, res: Response) => {
 ...
 */
notificationsRouter.post('/notifications/campaigns', requireAuth, async (req: Request, res: Response) => {
 ...
 */
notificationsRouter.delete('/notifications/campaigns/:campaignId', requireAuth, async (req: Request, res: Response) => {
