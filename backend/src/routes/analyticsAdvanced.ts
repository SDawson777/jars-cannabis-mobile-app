    ...
    try {
      res.json({
        users: [
          {
            userId: 'user-1',
            attributes: { email: 'j***@example.com', lifetimeValue: 650, orders: 12 },
          },
          {
            userId: 'user-2',
            attributes: { email: 's***@example.com', lifetimeValue: 520, orders: 8 },
          },
        ],
      });
    } catch (error) {
